 ...
 */
Ext.define(//
    'cn.com.pingouin.vbp_client_template_modification.modules.helpers.RuntimeConfigHelper'//
    , {
      ...
      statics : {
        ...
        updateRuntimeConfigComponentWithPrintRangeForDisabledByCheckbox : function() {
          ...
          // 勾选才可以调整打印范围
          this.updateRuntimeConfigComponentWithPrintRangeStartForDisabled(!printRangeCheckbox.getValue());
          this.updateRuntimeConfigComponentWithPrintRangeEndForDisabled(!printRangeCheckbox.getValue());
          this.updateRuntimeConfigComponentWithPrintRangeButtonForDisabled(!printRangeCheckbox.getValue());
          
          // 勾选则锁定数据列表
          cn.com.pingouin.vbp_client.modules.helpers.DataGridHelper.lockedSelectionModel(printRangeCheckbox
              .getValue());
        },
