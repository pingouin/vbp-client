...
<script type="text/javascript" src="<%= request.getContextPath()%>/js/cn/com/pingouin/vbp_client/VbpPrintZoneFunctions.js"></script>
<script type="text/javascript">
	var vbpPrintZoneFunctions = Ext.create('cn.com.pingouin.vbp_client.VbpPrintZoneFunctions');
	// test
	var vbpConfiguration = top.vbpConfiguration;
</script>
<script type="text/javascript">
...
<script type="text/javascript">
	function printZonePreviewWithSelectedData(selectedRecord) {
		var LODOP = getLodopGlobal();
		
		vbpPrintZoneFunctions.printZonePreviewWithSelectedData(selectedRecord, LODOP);
	}
</script>
<script type="text/javascript">
	function vbpTemplateSave() {
...
<script type="text/javascript" src="<%= request.getContextPath()%>/js/cn/com/pingouin/vbp_client/VbpPrintZoneIFrame.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/js/cn/com/pingouin/vbp_client/VbpPrintZonePanel.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/js/cn/com/pingouin/vbp_client/VbpFloatDivisionConfigWindow.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/js/cn/com/pingouin/vbp_client/VbpFloatDivisionConfigPanel.js"></script>
