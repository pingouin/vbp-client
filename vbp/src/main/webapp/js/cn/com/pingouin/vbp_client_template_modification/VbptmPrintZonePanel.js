    ...
    , {
      ...
      initComponent : function() {
		...
		// 接收到的设置参数
      	...
      	// 漂浮框可选择的取值表达式数组
      	this.valueFetchExpressions = new Array();
      	if(Ext.isArray(vbpConfiguration.basicSetting.valueFetchExpressions)) {
      		this.valueFetchExpressions = vbpConfiguration.basicSetting.valueFetchExpressions;
      	}
      	...
      	this._superclass_ = cn.com.pingouin.vbp_client_template_modification.VbptmPrintZonePanel.superclass;
			...
			, function(eventObject, htmlElement, eOpts) {
			   	var vbpFloatDivisionConfigWindow = Ext.create(
			    	...
			    	, {
			    	    ...
			    	    valueFetchExpressions : me.valueFetchExpressions
			    	}
			    );
